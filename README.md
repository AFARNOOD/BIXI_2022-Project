...
If you want to reproduce results by running [notebooks](https://github.com/AFARNOOD/BIXI_2022-Project/tree/main/notebooks) or (https://github.com/AFARNOOD/BIXI_2022-Project/blob/main/train.py), you need to download data.
